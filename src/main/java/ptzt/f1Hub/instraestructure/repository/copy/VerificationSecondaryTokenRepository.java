...
import ptzt.f1Hub.domain.models.copy.VerificationToken;

import java.time.LocalDateTime;
import java.util.List;
import java.util.Optional;

public interface VerificationSecondaryTokenRepository extends JpaRepository<VerificationToken, Long> {
